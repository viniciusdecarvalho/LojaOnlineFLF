...
namespace LojaOnlineFLF.Repositories
{
    public class RepositoryFactory: IRepositoryFactory
    {
        ...
        private readonly Dictionary<Type, Func<LojaEFContext, SignInManager<Acesso>, UserManager<Acesso>, object>> providers = new Dictionary<Type, Func<LojaEFContext, SignInManager<Acesso>, UserManager<Acesso>, object>>();
